        ...
        <Hero
          ...
          headline={
            <>
              ...
              <span className="hero-title-accent-shadow text-emerald-300/90">Start using it.</span>
            </>
          }
          subtext="12 weeks. One real build. A business that runs on AI — not just talks about it."
        />

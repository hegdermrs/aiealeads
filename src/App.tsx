    ...
    <div className="min-h-screen bg-black text-white antialiased">
      ...
      <main>
        ...
        <CtaBlock
          ...
          imageAlt="A surgical theatre of AI tools — Claude, OpenAI, n8n, Grok, ChatGPT, Cursor — operating on a glowing business core."
        />

        <Founder />

        {/* Testimonial spread #3 */}
        <Testimonial
